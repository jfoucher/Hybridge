/*
 * Piet — a Mondrian composition.  Date, steps and calories live in
 * the cells; the tall right cell is a battery gauge built with the
 * official masked-solid technique (solid drawn under a transparent
...
return {
	...
	"compute": function () {
		...
		var bh = Math.max(2, Math.round(soc * 0.68));
		return {
			"json_file": 'piet_layout',
			"bh": bh,
			"btop": 144 - bh,
			"date": '' + (c.date || 1),
