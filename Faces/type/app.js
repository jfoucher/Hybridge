/*
 * Type - the weekday set huge in the Swiss manner, the date squared beneath a heavy rule, steps in the footer.
 */
return {
	"node_name": '',
	...
	"compute": function () {
		...
		return {
			"json_file": 'type_layout',
			"dow": full[dow],
			"date": '' + (c.date || 1),
			"steps": this.fmt_steps(c.step_count) + ' STEPS'
		};
	},
