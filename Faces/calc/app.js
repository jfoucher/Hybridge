/*
 * Calc — a pocket calculator.  Steps on the LCD, calories in memory,
 * the date above the display, and the hands hub is the OFF button.
 */
return {
	"node_name": '',
	...
	"compute": function () {
		...
		return {
			"json_file": 'calc_layout',
			"lcd": '' + (c.step_count || 0),
			"mem": 'M ' + (c.calories || 0),
			"date": (c.date || 1) + ' ' + this.mons[c.month || 0]
		};
	},
