/*
 * Arcade — a space-invaders scoreboard: steps are your SCORE, the
 * daily goal is HI, and the heart holds your battery.
 */
return {
	"node_name": '',
	...
	"compute": function () {
		...
		return {
			"json_file": 'arcade_layout',
			"score": this.pad(c.step_count),
			"hi": this.pad(goal),
