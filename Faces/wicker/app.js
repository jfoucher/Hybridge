/*
 * Wicker - a woven basketweave dial: interlaced straw bundles under four
 * fine cartouches carrying steps, calories, battery and the date.
 */
return {
	"node_name": '',
