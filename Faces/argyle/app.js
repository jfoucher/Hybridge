/*
 * Argyle - a knitted argyle dial: a lattice of two-tone diamonds under
 * dotted intercross lines, with steps, heart rate, battery and date set
 * in four fine cartouches.
 */
return {
	"node_name": '',
